...
sim_path = os.path.join('./brunel_simulations_10p_posteriors_rate')
...
np.save('posterior_simulations_rate.npy', histpsds)
np.save('posterior_simulations_rate_lfp.npy.npy', lfppsds)
np.save('posterior_simulations_rate_labels.npy', ps)
