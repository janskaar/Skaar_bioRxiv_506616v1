...
STOP_PERSISTENCE = 5      # number of epochs to train without loss improvement before stopping
STOP_THRESHOLD = 1.       # value to consider "not significantly improving"

def train(model, train_batch_fn, eval_batch_fn, train_loader, eval_train_loader, eval_test_loader, logfile=None, savefile=None):
    min_loss = 1e10
